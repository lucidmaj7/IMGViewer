...
void CIMGViewerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CIMGViewerDoc::InitializeSearchContent()
{
...
void CIMGViewerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
